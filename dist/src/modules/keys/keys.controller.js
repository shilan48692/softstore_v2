...
const create_bulk_keys_dto_1 = require("./dto/create-bulk-keys.dto");
...
__decorate([
    ...
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [create_bulk_keys_dto_1.CreateBulkKeysDto]),
    __metadata("design:returntype", Promise)
], KeysController.prototype, "createBulk", null);
__decorate([
    (0, common_1.Patch)(':id'),
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard),
    (0, common_1.UsePipes)(new common_1.ValidationPipe({ transform: true, whitelist: true, forbidNonWhitelisted: true })),
